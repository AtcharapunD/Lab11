...
public class Chap11_03 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (name.exists()) {
          ...
          // not file or directory, output error message
            ...
            JOptionPane.showMessageDialog(this, actionEvent.getActionCommand() + " Does Not Exist", "ERROR",JOptionPane.ERROR_MESSAGE);
        }
    } // end method actionPerformed
    
    public static void main(String args[]) {
        Chap11_03 application = new Chap11_03();
